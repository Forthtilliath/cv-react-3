      ...
      <div className="card">
        <div className="card-content">
          ...
          <p className="grey-text">
            ...
            at eveniet repudiandae, illo nobis, explicabo minus ipsum, facere
            quo ab ut? Pariatur nostrum repellendus laborum commodi quia qui
            cupiditate?
          </p>
        </div>
        <div className="card-action">
          ...
          <div className="row mt">
            <div className="col s12 m6 l6 xl6">
              <p>
                <strong>Adresse :</strong> 49000 ANGERS
              </p>
              <p>
